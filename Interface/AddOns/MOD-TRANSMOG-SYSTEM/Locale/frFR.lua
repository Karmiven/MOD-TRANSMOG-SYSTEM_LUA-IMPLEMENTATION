...
L["MINIMAP_TOOLTIP_LEFT"] = "|cffffffffClic Gauche:|r Ouvrir la fenêtre de Transmog"
L["MINIMAP_TOOLTIP_RIGHT"] = "|cffffffffClic Droit:|r Afficher l'aide"
...
L["SETTING_BG_MISCELLANEOUS"] = "Divers"
